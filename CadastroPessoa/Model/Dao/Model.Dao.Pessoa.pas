   ...
   try
      FConexao
         .SQL('UPDATE PESSOAS SET NOME = :NOME, CPF = :CPF, '+
              'RG = :RG, NOME_MAE = :NOMEMAE, NOME_PAI = :NOMEPAI '+
              'WHERE ID = :ID')
         .Params('NOME', FPessoa.Nome)
         .Params('CPF', FPessoa.CPF)
         .Params('RG', FPessoa.RG)
         .Params('NOMEMAE', FPessoa.NomeMae)
         .Params('NOMEPAI', FPessoa.NomePai)
   ...
   try
      FConexao
        .SQL('INSERT INTO PESSOAS (NOME, CPF, RG, NOME_MAE, NOME_PAI) '+
             'VALUES (:NOME, :CPF, :RG, :NOMEMAE, :NOMEPAI)')
           .Params('NOME', FPessoa.Nome)
           .Params('CPF', FPessoa.CPF)
           .Params('RG', FPessoa.RG)
           .Params('NOMEMAE', FPessoa.NomeMae)
