...
uses
  ...
  FireDAC.DApt, FireDAC.Comp.DataSet, Conexao.Interfaces, Data.DB, SysUtils, Forms, Vcl.Dialogs;
...
begin
   ...
   //FConexao.Params.Add('DataBase=C:\Users\italo\Documents\Delphi\Farmacia\dados.sdb');
   //showmessage(ExtractFilePath(Application.ExeName)+'dados.sdb');
   FConexao.Params.Add('DataBase='+ExtractFilePath(Application.ExeName)+'dados.sdb');
